# flake.nix
#
# This file packages licdata-events-infrastructure as a Nix flake.
#
# Copyright (C) 2024-today acm-sl's Licdata Events Infrastructure
#
...
{
  description = "Nix flake for acmsl/licdata-events-infrastructure";
  inputs = rec {
  ...
  outputs = inputs:
    ...
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        description = "Infrastructure layer for Licdata events";
        ...
        acmsl-licdata-events-infrastructure-for = { acmsl-licdata-events, python
          , pythoneda-shared-pythonlang-banner
          , pythoneda-shared-pythonlang-domain
          , pythoneda-shared-pythonlang-infrastructure }:
          let
          ...
          in python.pkgs.buildPythonPackage rec {
            ...
            postInstall = with python.pkgs; ''
              ...
              for dep in ${acmsl-licdata-events} ${pythoneda-shared-pythonlang-domain} ${pythoneda-shared-pythonlang-infrastructure}; do
      ...
      in rec {
        ...
        devShells = rec {
          default = acmsl-licdata-events-infrastructure-python312;
          acmsl-licdata-events-infrastructure-python39 =
            shared.devShell-for {
              banner = "${
              ...
              package =
                packages.acmsl-licdata-events-infrastructure-python39;
          ...
          acmsl-licdata-events-infrastructure-python310 =
            shared.devShell-for {
              banner = "${
              ...
              nixpkgs-release = nixpkgsRelease;
              package =
                packages.acmsl-licdata-events-infrastructure-python310;
          ...
          acmsl-licdata-events-infrastructure-python311 =
            shared.devShell-for {
              banner = "${
              ...
              nixpkgs-release = nixpkgsRelease;
              package =
                packages.acmsl-licdata-events-infrastructure-python311;
          ...
          acmsl-licdata-events-infrastructure-python312 =
            shared.devShell-for {
              banner = "${
              ...
              nixpkgs-release = nixpkgsRelease;
              package =
                packages.acmsl-licdata-events-infrastructure-python312;
          ...
          acmsl-licdata-events-infrastructure-python313 =
            shared.devShell-for {
              banner = "${
              ...
              nixpkgs-release = nixpkgsRelease;
              package =
                packages.acmsl-licdata-events-infrastructure-python313;
        ...
        packages = rec {
          default = acmsl-licdata-events-infrastructure-python312;
          acmsl-licdata-events-infrastructure-python39 =
            acmsl-licdata-events-infrastructure-for {
